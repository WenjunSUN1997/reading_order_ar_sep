...
if __name__ == "__main__":
    lang = 'fr'
    if lang == 'fr':
        path = '../../seperator_ar_sep/article_dataset/AS_TrainingSet_BnF_NewsEye_v2/'
    else:
        path = '../../seperator_ar_sep/article_dataset/AS_TrainingSet_NLF_NewsEye_v2/'
    ...
    image_path_list = [
                       ...
                       if '.jpg' in x
                       # and '18680715_1-0001' in x
                       ]
    for image_path in tqdm(image_path_list):
        print(image_path)
        os.makedirs(save_path+image_path.replace('.jpg', '/'), exist_ok=True)
        try:
            split_link_by_name(image_path=path+image_path,
    ...
    # E:\code\test\seperator_ar_sep\article_dataset\AS_TrainingSet_BnF_NewsEye_v2
